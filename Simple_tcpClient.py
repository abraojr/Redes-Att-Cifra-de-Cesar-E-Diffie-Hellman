...
if __name__ == "__main__":
    ...
    clientSocket.send(bytes(envio(sentMessage, p, g, privateSecret), "utf-8"))

    #### MENSAGEM RECEBIDA ####
    # recebe a mensagem do servidor
    receivedMessage = str(clientSocket.recv(65000),"utf-8")
    print ("Texto recebido: ", receivedMessage)
